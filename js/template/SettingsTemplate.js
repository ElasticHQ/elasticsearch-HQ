...
settingsTemplate.init = [
    ...
    '<tbody>',
    '<tr>',
    '<td style="white-space: nowrap;"><label for="enablePolling"><strong>Enable Polling?</strong></label></td>',
    '<td>',
    '<div class="controls">',
    '<label class="checkbox">',
    '<input type="checkbox" id="chkPollingEnabled" value="on" name="pollingEnabled" <%- settings.pollingEnabled ? "checked" : "" %> /> Enable polling for index data',
    '</label>',
    '</div>',
    '</td>',
    '<td>Enable continuous ajax polling.</td>',
    '</tr>',
    ...
    '<div class="controls">',
    '<input type="text" <%- !settings.pollingEnabled ? "disabled" : "" %> value="<%- settings.poller.cluster %>" id="clusterPoller" name="clusterPoller" placeholder="" class="input"  data-error-style="tooltip">',
    ...
    '<div class="control-group">',
    '<div class="controls">',
    '<input type="text" <%- !settings.pollingEnabled ? "disabled" : "" %> value="<%- settings.poller.nodeDiagnostics %>" id="ndPoller" name="ndPoller" placeholder="" class="input"  data-error-style="tooltip">',
    '<span class="add-on">ms.</span>',
    '</div>',
    '</div>',
    '</div>',
    ...
    '<div class="control-group">',
    '<div class="controls">',
    '<input type="text" <%- !settings.pollingEnabled ? "disabled" : "" %> value="<%- settings.poller.node %>" id="nPoller" name="nPoller" placeholder="" class="input"  data-error-style="tooltip">',
    '<span class="add-on">ms.</span>',
    '</div>',
    '</div>',
    '</div>',
    ...
    '<div class="control-group">',
    '<div class="controls">',
    '<input type="text" <%- !settings.pollingEnabled ? "disabled" : "" %> value="<%- settings.poller.indices %>" id="indicesPoller" name="indicesPoller" placeholder="" class="input"  data-error-style="tooltip">',
    '<span class="add-on">ms.</span>',
    '</div>',
    '</div>',
    '</div>',
    ...
    '<div class="control-group">',
    '<div class="controls">',
    '<input type="text" <%- !settings.pollingEnabled ? "disabled" : "" %> value="<%- settings.poller.index %>" id="indexPoller" name="indexPoller" placeholder="" class="input"  data-error-style="tooltip">',
    '<span class="add-on">ms.</span>',
    '</div>',
    '</div>',
    '</div>',
