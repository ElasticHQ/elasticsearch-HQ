...
nodeTemplate.diagnostics = [
    ...
    '<span><strong>(</strong><a href="#" rel="popRight" data-placement="right" data-content="<%- rule.comment %>" data-trigger="hover" data-html="true"><strong>?</strong></a><strong>)</strong></span>',
    '<% } %>',
    '</td>',
    ...
    '</div>',
    '<div class="modal-body">',
    '<p>This screen provides helpful information for common metrics and performance problems. ',
    'Mouseover the <b>(?)</b> symbol next to the appropriate label for hints.</p>',
