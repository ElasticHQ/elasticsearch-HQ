...
queryTemplate.sideNav = [
    ...
    '<div id="collapseIndices" class="accordion-body collapse in">',
      '<div class="accordion-inner" style="padding-left: 0px;">',
        '<select id="indices" class="span12 selectpicker" data-container="body" multiple>',
    ...
    '<a data-toggle="collapse" data-parent="#queryAccordion" href="#collapseTypes">',
    '<b><i class="icon-expand-alt"></i> Types</b>',
    '</a>',
    '<a href="#toggleTypes" id="toggleTypes" class="pull-right checked">',
    '<b><i class="icon-check"></i> Toggle</b>',
    '</a>',
    '<div id="collapseTypes" class="accordion-body collapse in">',
        '<ul class="nav nav-list" id="typelist">',
        '</ul>',
    '</div>',
    ...
    '<ul class="nav nav-list" id="fields">',
    '</ul>',
